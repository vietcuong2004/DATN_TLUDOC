                ...
                <Card className="h-[calc(100vh-220px)] rounded-2xl border-blue-100 shadow-[0_18px_45px_-30px_rgba(15,23,42,0.35)] flex flex-col">
                  <CardContent className="flex-1 p-4 overflow-hidden flex flex-col">
                    ...
                    <div
                      ...
                      className="flex-1 overflow-y-auto rounded-xl bg-transparent p-3 pr-2 space-y-4"
                    >
                      {messages.map((message) => {
                        ...
                        return (
                          ...
                          >
                            <div
                              className={`flex ${isUser ? "flex-row-reverse max-w-[85%] md:max-w-[80%]" : "flex-row w-full max-w-full md:max-w-[80%]"} gap-3`}
                            >
                              {message.role === "assistant" && (
                                <Avatar className="h-8 w-8 hidden md:flex shrink-0">
                              ...
                              <div className="space-y-2 w-full overflow-hidden">
                                <div
                                  className={`overflow-hidden w-full ${isUser
                                    ? "p-3 md:p-4 rounded-2xl bg-indigo-700 text-white shadow-md rounded-tr-none text-sm md:text-base"
                                    : "p-3 md:p-4 rounded-2xl bg-slate-50 border border-slate-100/80 text-slate-800 text-sm md:text-base rounded-tl-none shadow-sm"
                                    }`}
                                >
                                  {message.role === "assistant" ? (
                                ...
                                <div
                                  className={`flex ${isUser ? "justify-start" : "justify-end"} text-xs text-gray-500`}
                                >
                      ...
                      {isLoading && (
                        <div className="flex justify-start">
                          <div className="flex flex-row w-full max-w-full md:max-w-[80%] gap-3">
                            <Avatar className="h-8 w-8 hidden md:flex shrink-0">
                              <AvatarImage src="/chatbot.png" alt="TLU Chatbot" />
                              <AvatarFallback className="bg-blue-100 text-blue-700">AI</AvatarFallback>
                            </Avatar>
                            <div className="p-3 md:p-4 rounded-2xl bg-slate-50 border border-slate-100/80 text-slate-800 text-sm md:text-base rounded-tl-none shadow-sm">
