  ...
  return (
    <footer className="bg-white border-t">
      <div className="container mx-auto px-4 pt-12 pb-4">
        {/* Logo TLU Document ở trên, căn giữa */}
        <div className="flex justify-center mb-8">
          <span className="text-4xl font-bold italic text-green-600">TLU Document</span>
        </div>
        {/* 3 cột nội dung */}
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row md:justify-between md:items-start text-center md:text-left gap-8">
          ...
          <div className="flex-1 mb-8 md:mb-0">
            ...
            <ul className="space-y-3">
              <li className="flex items-center justify-center md:justify-start">
                ...
                <span className="text-gray-600">info@tludocument.vn</span>
              </li>
              <li className="flex items-center justify-center md:justify-start">
          ...
          <div className="flex-1">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="#" className="text-gray-600 hover:text-green-500">TLU Document là gì?</Link>
              </li>
            </ul>
          </div>
        </div>
        <div className="border-t mt-8 pt-4 text-center text-gray-500 text-sm">
          Copyright © 2026 TLU Document. Designed by TLU Document
        </div>
      </div>
    </footer>
  )
